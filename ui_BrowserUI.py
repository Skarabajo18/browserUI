...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_6.setStyleSheet("background-color: rgb(255, 115, 34);\n"
                                   "border-radius:7px;")
        ...
        self.label_5.setStyleSheet("background-color: rgb(255, 115, 34);\n"
        ...
        self.label_4.setStyleSheet("background-color: rgb(255, 115, 34);\n"
                                   "border:4px solid rgb(45,45,45);\n"
                                   "border-radius:7px;")
        ...
        self.label_3.setStyleSheet("color: rgb(189, 189, 189);")
        ...
        self.webEngineView = QWebEngineView(parent=self.widget)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "SKARABAJO"))
        ...
        self.label_2.setText(_translate("Form", "Desarrollado por Skarabajo"))
